...
const RestaurantCard = (props) =>{
    ...
    return(
        <div data-testid="resCard" className="m-4 w-[290px] h-fit object-cover rounded-md hover:scale-95">

            <img alt ="card-logo" className="m-1 w-[290px] h-[190px] rounded-lg" src={CDN_URL+cloudinaryImageId}/>
